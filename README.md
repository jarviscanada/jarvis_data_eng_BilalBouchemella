...
**Java Grep App** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_BilalBouchemella/tree/master/core_java/grep)]: Built a Linux monitoring agent that collects hardware details and tracks CPU, memory, and disk usage across several machines. Used Bash scripts, Docker, Post
